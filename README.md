...
- `build/` - Compiled JavaScript, CSS, and PHP asset files (generated by `npm run build`)
- `src/` - TypeScript/JavaScript source files organized by functionality
  - `src/js/` - JavaScript/TypeScript modules (theme.ts, accessibility.ts, style-engine.ts)
- `bin/` - Executable scripts and build utilities

### Testing Infrastructure
- `tests/` - Comprehensive testing suite organized by type
  - `tests/e2e/` - End-to-end Playwright tests for user workflows
  - `tests/unit/` - Unit tests for JavaScript functions and components
  - `tests/integration/` - Integration tests for WordPress functionality
  - `tests/php/` - PHPUnit tests for WordPress PHP code
- `test-results/` - Test execution results and artifacts
- `playwright-reports/` - Playwright test reports and screenshots
- `coverage/` - Code coverage reports from Jest and other tools

### WordPress Theme Structure
- `functions.php` - Theme setup and functionality
- `theme.json` - Block theme configuration and design tokens
...
- `styles/` - Theme style variations for different design schemes
- `templates/` - Block templates for Full Site Editing (FSE)

### AI/Copilot Assets
- `.github/instructions/` - Contextual behavioral guidance (32 files, auto-applied)
- `.github/prompts/` - Single-shot reusable tasks and templates (70+ files)
- `.github/chatmodes/` - Persistent conversational personas (18 modes)
- `.github/agents/` - Specialized AI agents for WordPress workflows (23+ agents)
