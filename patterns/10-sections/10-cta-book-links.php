...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-30pacing-60","bottom":"var:preset|spacing|spacing-30pacing-60"},"blockGap":"var:preset|spacing|spacing-30pacing-50","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","contentSize":"800px"}} -->
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--spacing-60);padding-bottom:var(--wp--preset--spacing--spacing-60)">
	<!-- wp:heading {"textAlign":"center","align":"wide","fontSize":"600"} -->
	...
	<!-- wp:buttons {"align":"wide","fontSize":"300","layout":{"type":"flex","justifyContent":"center","flexWrap":"wrap"}} -->
