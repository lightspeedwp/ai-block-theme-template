...
<h1 class="wp-block-heading has-text-align-center has-secondary-font-family has-800-font-size"><?php esc_html_e( 'Build your site with clicks, not code.', 'lsx-design' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
