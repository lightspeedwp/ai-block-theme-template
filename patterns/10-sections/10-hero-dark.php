...
<div class="wp-block-group lsx-hero-content" style="padding-bottom:var(--wp--preset--spacing--90)"><!-- wp:group {"className":"lsx-hero-titles","style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30"}},"layout":{"type":"constrained"}} -->
