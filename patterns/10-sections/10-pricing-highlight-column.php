 ...
 */
?>
<!-- wp:group {"className":"lsx-pricing-highlight","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-70","bottom":"var:preset|spacing|spacing-70","left":"var:preset|spacing|spacing-50","right":"var:preset|spacing|spacing-50"}},"border":{"radius":"8px","width":"1px"}},"backgroundColor":"main","textColor":"base","borderColor":"border-dark","layout":{"type":"constrained"}} -->
...
<!-- wp:separator {"className":"is-style-separator-thin","style":{"spacing":{"margin":{"top":"var:preset|spacing|spacing-50","bottom":"var:preset|spacing|spacing-50"}}},"backgroundColor":"border-dark"} -->
