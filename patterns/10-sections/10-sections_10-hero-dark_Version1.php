 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'patterns/images/guy-laptop.webp' ) ); ?>","dimRatio":80,"overlayColor":"main","isUserOverlayColor":true,"align":"full","className":"is-style-blur-image is-style-blur-image-less","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
<div class="wp-block-cover alignfull is-style-blur-image is-style-blur-image-less" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><span aria-hidden="true" class="wp-block-cover__background has-main-background-color has-background-dim-80 has-background-dim"></span><img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'Person working on laptop', 'lsx-design' ); ?>" src="<?php echo esc_url( get_theme_file_uri( 'patterns/images/guy-laptop.webp' ) ); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"full","className":"lsx-hero-dark-wrap","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-30pacing-90","right":"var:preset|spacing|spacing-30pacing-50","bottom":"0","left":"var:preset|spacing|spacing-30pacing-50"},"margin":{"top":"0","bottom":"0"},"blockGap":"0px"}},"textColor":"base","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull lsx-hero-dark-wrap has-base-color has-text-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--spacing-90);padding-right:var(--wp--preset--spacing--spacing-50);padding-bottom:0;padding-left:var(--wp--preset--spacing--spacing-50)"><!-- wp:group {"className":"lsx-hero-content","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|spacing-30pacing-90"}}}} -->
<div class="wp-block-group lsx-hero-content" style="padding-bottom:var(--wp--preset--spacing--spacing-90)"><!-- wp:group {"className":"lsx-hero-titles","style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30pacing-30"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group lsx-hero-titles"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"main-accent","fontSize":"200"} -->
...
<p class="has-text-align-center has-main-accent-color has-text-color"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the Site Editor and LSX Design patterns. No coding skills required.', 'lsx-design' ); ?></p>
<!-- /wp:paragraph -->
