 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Footer"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-80","bottom":"var:preset|spacing|spacing-80","right":"var:preset|spacing|spacing-50","left":"var:preset|spacing|spacing-50"},"margin":{"top":"0px"},"blockGap":"var:preset|spacing|spacing-70"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"main","textColor":"base","layout":{"inherit":true,"type":"constrained"}} -->
...
<!-- wp:group {"metadata":{"name":"Navs"},"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30"}},"fontSize":"200","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
