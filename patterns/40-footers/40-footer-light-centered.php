 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Footer"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-30pacing-80","bottom":"var:preset|spacing|spacing-30pacing-80","right":"var:preset|spacing|spacing-30pacing-50","left":"var:preset|spacing|spacing-30pacing-50"},"margin":{"top":"0px"},"blockGap":"var:preset|spacing|spacing-30pacing-70"},"border":{"top":{"color":"var:preset|color|border-light","width":"1px"},"right":[],"bottom":[],"left":[]},"elements":{"link":{"color":{"text":"var:preset|color|main"}}}},"backgroundColor":"base","textColor":"main","layout":{"inherit":true,"type":"constrained"}} -->
...
<!-- wp:group {"metadata":{"name":"Links"},"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30pacing-30"}},"fontSize":"200","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
