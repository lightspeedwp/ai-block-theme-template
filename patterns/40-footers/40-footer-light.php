 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Footer"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-30pacing-90","bottom":"var:preset|spacing|spacing-30pacing-90","right":"var:preset|spacing|spacing-30pacing-50","left":"var:preset|spacing|spacing-30pacing-50"},"margin":{"top":"0px"},"blockGap":"var:preset|spacing|spacing-30pacing-70"},"elements":{"link":{"color":{"text":"var:preset|color|main"}}},"border":{"top":{"color":"var:preset|color|border-light","width":"1px"},"right":[],"bottom":[],"left":[]}},"backgroundColor":"base","textColor":"main","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull has-main-color has-base-background-color has-text-color has-background has-link-color" style="border-top-color:var(--wp--preset--color--border-light);border-top-width:1px;margin-top:0px;padding-top:var(--wp--preset--spacing--spacing-90);padding-right:var(--wp--preset--spacing--spacing-50);padding-bottom:var(--wp--preset--spacing--spacing-90);padding-left:var(--wp--preset--spacing--spacing-50)"><!-- wp:columns {"metadata":{"name":"Footer Columns"},"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|spacing-30pacing-80","left":"var:preset|spacing|spacing-30pacing-80"}}}} -->
...
<p class="has-small-font-size"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Ollie block theme. No coding skills required. Download for free today!', 'lsx-design' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:social-links {"iconColor":"base","iconColorValue":"var(--wp--preset--color--base)","iconBackgroundColor":"main","iconBackgroundColorValue":"var(--wp--preset--color--primary)","className":"is-style-default","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|spacing-30pacing-30","left":"var:preset|spacing|spacing-30pacing-30"}}},"layout":{"type":"flex","justifyContent":"left"}} -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30pacing-30"}},"fontSize":"200","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide has-secondary-color has-text-color has-link-color" style="padding-top:40px"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30pacing-30"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"200"} -->
<p class="has-small-font-size"><?php esc_html_e( '© 2025', 'lsx-design' ); ?><strong><?php esc_html_e( '·', 'lsx-design' ); ?></strong><?php esc_html_e( '&nbsp;Powered by WordPress and', 'lsx-design' ); ?><a href="https://olliewp.com"><?php esc_html_e( 'Ollie', 'lsx-design' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|spacing-30pacing-30"}},"fontSize":"200","layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
