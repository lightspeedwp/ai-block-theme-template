 ...
 */
?>
<!-- wp:group {"align":"full","className":"lsx-footer-primary","style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-30pacing-70","bottom":"var:preset|spacing|spacing-30pacing-70"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull lsx-footer-primary" style="padding-top:var(--wp--preset--spacing--spacing-70);padding-bottom:var(--wp--preset--spacing--spacing-70)"><!-- wp:columns {"align":"wide"} -->
...
<!-- wp:separator {"style":{"spacing":{"margin":{"top":"var:preset|spacing|spacing-30pacing-50"}}}} -->
