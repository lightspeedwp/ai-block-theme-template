 ...
 */
?>
<!-- wp:group {"align":"wide","style":{"border":{"radius":"8px","width":"1px","color":"var(--wp--preset--color--primary)"},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"},"spacingPreset":"compact"},"layout":{"type":"constrained"}} -->
