<?php
/**
 * Title: Mobile Menu 3 (LSX)
 * Slug: lsx-design/mobile-menu-3
 * Description: Mobile menu with host/profile and quick links (LSX).
 * Categories: lsx-design/menu
 * Keywords: mobile, menu, host, profile
 * Viewport Width: 600
...
<div class="wp-block-group is-style-default has-base-background-color has-background" style="border-radius:10px;padding-right:0;padding-left:0">
  <!-- Profile header and stacked nav preserved -->
</div>