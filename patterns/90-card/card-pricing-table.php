 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Pricing Table Card","categories":["ollie/pricing"],"patternName":"ollie/pricing-table-card"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-70","bottom":"var:preset|spacing|spacing-70","left":"var:preset|spacing|spacing-70","right":"var:preset|spacing|spacing-70"},"blockGap":"var:preset|spacing|spacing-50"},"border":{"radius":"5px","width":"1px"}},"borderColor":"border-light","layout":{"type":"constrained"}} -->
